...
double f(double x,double y)
{
    ...
    //double r = 2*pi*pi*cos(pi*x)*cos(pi*x);
    double r = x + y;
    return r;
}
...
int main() {
    ...
    int N1 = 2,N2 = N1;
	double h = max((right - left)/N1,(top - bottom)/N2);
...
/*     FEKernel::assembleV_2D(N,Nlbtest,basis_type_test,0,0,P,T,Pb,Tb,V,f); */
	...
	/* cout << "analytic_solution" <<endl<< x1 <<endl; */
	/* //计算无穷范数 */
    /* double error = (x - x1).maxnorm(); */
    /* cout << error <<endl; */
