...
public:
	...
	static void treat_boundary_Dirichlet_2d_specialcase(Matrix &boundarynodes,Matrix &A,Matrix &Pb,Vector &b,F (*g1)(F,F),F (*g2)(F,F)){
	    return FEMethod::treat_boundary_Dirichlet_2d_specialcase<F, I, Matrix, Vector>(boundarynodes, A, Pb, b, g1, g2);
	}
	static void treat_boundary_Dirichlet_2d_SpMat_sp(Matrix &boundarynodes,SpMat &A,SpMat &A1,Matrix &Pb,Vector &b,F (*g1)(F,F),F (*g2)(F,F)){
	    return FEMethod::treat_boundary_Dirichlet_2d_SpMat_sp<F,I,Matrix,Vector,SpMat>(boundarynodes,A,A1,Pb,b,g1,g2);
	}
	static void addSpMat(SpMat &A,SpMat &M,I rowstart,I colstart){
	    return FEMethod::addSpMat<I, SpMat>(A, M, rowstart, colstart);
	}
	static void generate_boundarynodes_2D_lack_right(Matrix &boundarynodes,I N1,I N2){
	    return FEMethod::generate_boundarynodes_2D_lack_right<F,I,Matrix>(boundarynodes, N1, N2);
	} 
