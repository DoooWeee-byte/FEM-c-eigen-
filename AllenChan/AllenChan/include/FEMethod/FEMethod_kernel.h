...
public:
	...
	static void assembleFE_coe_pow2_2D(I der_x_coe,I der_y_coe,I basis_type_coe,Vector &solution_vec,I N,I Nlbtest,I Nlbtrial,I basis_type_test,I basis_type_trial,const Matrix &P,const Matrix &T,const Matrix &Tb_test,const Matrix &Tb_trial,SpMat &A,F (*c)(F,F),I r,I s,I p,I q,I Gpn = 4) {
        return FEMethod::assembleFE_coe_2D<F,I,Matrix,Vector, SpMat>(der_x_coe,der_y_coe,basis_type_coe,solution_vec,N,Nlbtest,Nlbtrial,basis_type_test,basis_type_trial,P,T,Tb_test,Tb_trial,A,c,r,s,p,q,Gpn);
    }
};
