...
public:
  ...
  static void assembleV_1d(I N,I Nlb,I basis_type_test,I der_x,const Matrix &P,const Matrix &T,const Matrix &Pb,const Matrix &Tb,Vector &v,F (*f)(F),I Gpn = 4){
    ...
    static void ODE_KS_1D_Solver(F Time,F delta_t,Matrix &A,Matrix &B,Matrix &Pb,Vector &x,F (*u0)(F)){
    	return FEMethod::ODE_KS_1D_Solver<F,I,Vector,Matrix>(Time,delta_t,A,B,Pb,x,u0);
    }
