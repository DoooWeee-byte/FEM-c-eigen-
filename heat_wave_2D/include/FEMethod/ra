...
public:
	...
	static void treat_boundary_Dirichlet_2d(Matrix &boundarynodes,Matrix &A,Matrix &Pb,Vector &b,F (*g)(F,F))
	{
		return FEMethod::treat_boundary_Dirichlet_2d<F,I,Matrix,Vector>(boundarynodes,A,Pb,b,g);
	}
