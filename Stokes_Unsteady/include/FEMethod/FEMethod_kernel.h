...
public:
	...
	static void ODE_Unsteady_Stokes(F Tmax,F Tmin,I N_t,I N,I Nlb,I Nb,I basis_type_test,F theta,Matrix &M,Matrix &A,Matrix &P,Matrix &T,Matrix &Pb,Matrix &Tb,Matrix &boundarynodes,Vector &x,Vector &x0,F (*f1)(F,F,F),F (*f2)(F,F,F),F (*g1)(F,F,F),F (*g2)(F,F,F)){
		return FEMethod::ODE_Unsteady_Stokes<F,I,Matrix,Vector>(Tmax,Tmin,N_t,N,Nlb,Nb,basis_type_test,theta,M,A,P,T,Pb,Tb,boundarynodes,x,x0,f1,f2,g1,g2);
	}
